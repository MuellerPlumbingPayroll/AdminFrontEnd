            ...
            <div className="p-g-12 p-md-9">
              <div className="dataTable">
                <DataTable value={testInfo} scrollable="true" scrollHeight="200px">
                  <Column field="code" header="Code" filter filterMatchMode="contains" filterType="inputtext" />
                  <Column field="desc" header="Description" filter filterMatchMode="contains" filterType="inputtext" />
