...
class TimeSheets extends React.Component {
  ...
  displaySelection(data) {
    ...
    if (data instanceof Array) { return <ul style={{ textAlign: 'left', margin: 0 }}>{data.map((car, i) => <li key={car.vin}>{`${car.vin} - ${car.year} - ${car.brand} - ${car.color}`}</li>)}</ul>; }
        ...
        <div className={mainPart}>
          <div className="p-g p-fluid dashboard">
            <div className="p-g-12 p-md-9">
              ...
              <div className="dataTable">
                <DataTable value={sales} scrollable="true" scrollHeight="200px">
                  <Column field="name" header="Name" filter filterMatchMode="contains" filterType="inputtext" selection={this.state.selectedCars} onSelectionChange={e => this.setState({ selectedCars: e.value })} />
            ...
            <div className="p-g-12 p-md-4">
              ...
              <h4>From:</h4>
              <Calendar minDate={miDate} maxDate={maDate} readOnlyInput value={this.state.date} onSelect={e => this.setState({ date: e.value })} showIcon />
            </div>
            <div className="p-g-12 p-md-4">
              <h4>To:</h4>
              <Calendar minDate={miDate} maxDate={maDate} readOnlyInput value={this.state.date} onSelect={e => this.setState({ date: e.value })} showIcon />
